 ...
 */
export default function indexedGenerator(lcgArg: LCGArg, initialSeed: number, maxFrame: number = Infinity): IterableIterator<IndexedGeneratorResult> {
    const g = generator(lcgArg, initialSeed, maxFrame);
